...
simoxa_feed = r'c:\projects\python\anton-goryunov-diploma\images\v2.mp4'
tolya_training_feed = r'c:\projects\python\anton-goryunov-diploma\images\v1.mp4'
...
#        print( "USAGE: facerec_demo.py </path/to/images> [</path/to/store/images/at>]")
 #       sys.exit()
    ...
    tsdirname = r'C:\projects\python\diploma\training-set'
...
def face_rec_with_model(model, feed):
    names = ['anton']
    if len(sys.argv) < 2:
        pass
#        print( "USAGE: facerec_demo.py </path/to/images> [</path/to/store/images/at>]")
...
#        print( "USAGE: facerec_demo.py </path/to/images> [</path/to/store/images/at>]")
 #       sys.exit()
    ...
    tolya_training_feed = r'c:\projects\python\anton-goryunov-diploma\images\v2.mp4'
    #camera = cv2.VideoCapture(0)
    camera = cv2.VideoCapture(tolya_training_feed)
